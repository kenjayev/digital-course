        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full flex-[1.2] lg:pl-8">
            ...
            <div className="max-w-[550px] m-auto w-full text-center md:text-start md:max-w-none md:px-6 lg:px-0 px-2">
              <h1 className="uppercase text-2xl md:text-4xl mb-2 font-semibold">
              ...
              <p className="line-through text-lg md:text-2xl tracking-[3px]">
                2,000,000 so'm
              </p>
              ...
              <div className="hidden sm:flex flex-col items-center md:items-start">
                <a
                  href="#coursePlan"
                  className="max-w-[60%] w-full rounded-lg mb-2 m-auto md:max-w-[77%] md:mx-0 md:text-lg p-4 text-base text-center font-semibold uppercase bg-gold text-black cursor-pointer"
                >
                  Ro'yhatdan o'tish
                </a>
                <p className="px-4 text-sm max-w-[450px] md:max-w-[77%] md:mx-0 w-full m-auto text-center">
